...
export function PlaceholdersAndVanishInput({
  ...
  return (
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-5 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
      ...
      <div className="absolute inset-0 flex items-center rounded-full pointer-events-none z-10">
